...
contract Badge  {
  ...
  function transfer(address _to, uint256 _value) public noSelf(_to) returns (bool success) {
  ...
  ///@notice emits Transfer
  function transferFrom(address _from, address _to, uint256 _value) public noSelf(_to) returns (bool success) {
