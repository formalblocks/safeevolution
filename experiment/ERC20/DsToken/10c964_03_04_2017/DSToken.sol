...
contract DSToken is IERC20 {
    ...
    function transfer( address to, uint value) public stoppable returns (bool ok) {
    ...
    /// @notice  emits  Transfer
    function transferFrom( address from, address to, uint value) public stoppable returns (bool ok) {
    ...
    function approve( address spender, uint value ) public stoppable returns (bool ok) {
